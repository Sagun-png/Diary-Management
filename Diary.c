...
void deleteMeet(){
    ...
    while(another == 'Y')
    {
        ...
        printf("\n\t\t\t\t[2] DELETE A PARTICULAR RECORD BY TIME\033[0m");
...
void editBlog(){
    ...
    printf("\t\t\t\t\033[0mPRESS ENTER TO EXIT EDITING MENU.");
    getch();
}
...
void editMeet(){
    ...
    do
    {
        ...
        printf("\n\t\t\033[0;35ENTER TIME:[hh:mm]: \033[0m");
        gets(time);
